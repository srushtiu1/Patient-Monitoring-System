...
$pay=0;
$counter = 0;
$sql="SELECT *,bill.*,patient_details.* FROM payment Join bill join patient_details WHERE (MONTH(pm_date)=$date and payment.pm_b_no=bill.b_no and bill.b_p_id=patient_details.p_id)";
$result = mysqli_query($link,$sql);
echo "<b>This month received payment</b>";
...
if($num_rows!=0)
{
		...
		echo "<a href='mon_pdf.php' target='_blank'><button type='submit' name='s' class='btn btn-warning' formtarget='_blank'>Save as PDF</button></a>";
