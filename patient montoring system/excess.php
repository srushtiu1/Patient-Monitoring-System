...
<li><a href="sample.php">Patientwise report</a></li>
	<li><a href="pending_payment_list.php">Outstanding Report</a></li><li class="active"><a href="excess.php">Excess Report</a>
       Reports<br>
       </li><li><a href="range.php">Waiting Time</a></li>
       <li><a href="export.php">Export Patient Data</a></li>
		</ul>
    </div>
    <div class="col-sm-10 sample text-left"> 
     <?php
...
while($row = mysqli_fetch_array($result))
	...
	echo " <td>" . $row['b_no']. "</td>" ;
			...
			echo " <td>" . substr($row['b_bal'],1,10) . "</td>";
			 echo "</tr>";
		}
echo "</div></table>";
...
if($num_rows!=0)
{
		...
		echo "<a href='exc_pdf.php' target='_blank'><button type='submit' name='s' class='btn btn-warning' formtarget='_blank'>Save as PDF</button></a>";
