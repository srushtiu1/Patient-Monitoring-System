...
$b_no = mysqli_real_escape_string($link, $_POST['b_no']);
$b_amt = mysqli_real_escape_string($link, $_POST['b_amt']);
$bill_amt = mysqli_real_escape_string($link, $_POST['bill_amt']);
$diff=$bill_amt-$b_amt;
$sql = "Update bill set `b_amt`='$bill_amt' , `b_bal`=`b_bal`+'$diff' WHERE b_no=$b_no";

if(mysqli_query($link, $sql)){
    //$p_id = $link->insert_id;
    //echo "New record created successfully. Last inserted ID is: " . $p_id;
    echo "Bill Amount Updated successfully.";
} else{
