...
$p_addr1 = mysqli_real_escape_string($link, $_POST['p_addr1']);
...
$sql = "Update patient_details set `p_fname`='$p_fname',`p_mname`='$p_mname',`p_lname`='$p_lname',`p_email`='$p_email',`p_phno`=$p_phno,`p_dob`='$p_dob',`p_age`=$p_age,`p_addr1`='$p_addr1',`p_city`='$p_city',`p_pin`='$p_pin',`p_area`='$p_area',`p_sugg`='$p_sugg',`p_gender`='$p_gender',`p_id`=$p_id WHERE p_id=$p_id";
