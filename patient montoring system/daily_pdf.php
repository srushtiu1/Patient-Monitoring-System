...
$pdf->Cell(20,12,"",0);
	$pdf->Cell(30,12,"Daily Report",0);
	$pdf->Cell(40,12,"",0);
	$pdf->Cell(40,12,"",0);
	$pdf->Cell(30,12,"Date: ".date('d-F-Y'),0);
$pdf->Ln();

//foreach($header as $heading) {
	$pdf->Cell(15,12,"Sr No",1,'','C');
	$pdf->Cell(45,12,"Name",1,'','C');
...
foreach($result as $row) {
	...
	$pdf->Cell(45,12,$row['p_fname'] ." ". $row['p_lname'],1,'','C');
...
$pdf->SetFont('Arial','',12);	
$pdf->Ln();
$pdf->Cell(87,12,"Total Amount",1,'','C');
