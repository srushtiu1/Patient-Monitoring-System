...
echo "<tr>";
		...
		if($row['v_chkin']=='no')
			echo "<td  bgcolor='#CDFAF9'  style='text-color:white;height:10px;' >". substr($row['v_chkout_time'],11,8)."</td>";
	else
	{
...
echo "</table></div>";
	...
	if($_SESSION['username']=='admin')
	{
		...
		echo '<button type="submit" value="Make Bill" name="bill" class="btn btn-default" id="myBtn"> Make Bill</button>';
	}		
?>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
     ...
     Enter Amount: <input type='number' name='b_amt'  width='100px'><br><br>
		<button type="submit" value="Make Bill" name="bill" class="btn btn-default" > Make Bill</button>
		</form>
    </div>
