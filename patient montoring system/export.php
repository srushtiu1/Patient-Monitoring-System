...
<li><a href="sample.php">Patientwise report</a></li>
	<li><a href="pending_payment_list.php">Outstanding Report</a></li><li><a href="excess.php">Excess Report</a>
       ...
       <li class="active"><a href="export.php">Export Patient Data</a></li>
		</ul>
    </div>
    <div class="col-sm-10 "> 
...
echo '<button type="submit1" name="submit1" class="btn btn-warning">Export</button>';
    }
      ?>
			</form>
		</div>
  ...
  <br>
  <a href="test.php"><button type="submit1" name="submit1" class="btn btn-warning">Export</button></a>
</div>
</body>
</html>